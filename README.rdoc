...
If you are using Rails, we recommend that you include a module called<br/>
RestGraph::RailsUtil into your Controllers. (Your code contributions<br/>
for other Ruby frameworks would be appreciated!). RestGraph::RailsUtil <br/>
...
If you are using Rails and rest-graph as a gem, you can include this<br/>
...
=== Utility Methods:
All the methods that obtain an access_token will automatically save it.<br/>

If you have the session in the cookies,<br/>
then RestGraph can parse the cookies:<br/>

 rg.parse_cookies!(cookies)

If you're writing a Rack application, you might want to parse<br/>
...
Data associated with the access_token (which might or might not<br/>
...
The following method returns the redirect URL for authorizing
