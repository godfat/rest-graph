...
* Tested with MRI 1.8.7 and 1.9.2 and Rubinius 1.1.1.
  ...
  let me know if rest-graph is working in JRuby, thanks!
...
Or if you want rails plugin and bleeding edge, in Rails3's Gemfile:
...
Or if you are using Rails2 and rest-graph as a gem, you can include this
