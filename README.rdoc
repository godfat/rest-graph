...
=== Default setup 
    ...
    # a YAML configuration file (here's a {sample}[http://github.com/cardinalblue/rest-graph/blob/master/test/config/rest-graph.yaml]).
    #
